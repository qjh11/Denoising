...
def read_args():
    ...
    parser.add_argument("--output_dir", default=r"C:\Users\DELL\PycharmProjects\pythonProject1\DeepDenoiser-main\deepdenoiser\output", help="Output directory (default: output)")
    parser.add_argument("--model_dir", default=r"C:\Users\DELL\PycharmProjects\pythonProject1\DeepDenoiser-main\model\190614-104802", help="Checkpoint directory (default: None)")
    parser.add_argument("--sampling_rate", default=100, type=int, help="sampling rate of pred data")
    parser.add_argument("--data_dir", default="C:/Users/DELL/PycharmProjects/pythonProject1/DeepDenoiser-main/Dataset/pred/", help="Input file directory")
    parser.add_argument("--data_list", default="C:/Users/DELL/PycharmProjects/pythonProject1/DeepDenoiser-main/Dataset/pred.csv", help="Input csv file")
    parser.add_argument("--plot_figure", action="store_true", default=True,help="If plot figure")
    parser.add_argument("--save_signal", action="store_true",default=True, help="If save denoised signal")
    parser.add_argument("--save_noise", action="store_true",default=False, help="If save denoised noise")
